...
LOCAL_MODULE := Ds
LOCAL_MODULE_OWNER := xiaomi
LOCAL_SRC_FILES := proprietary/app/Ds/Ds.apk
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_SUFFIX := $(COMMON_ANDROID_PACKAGE_SUFFIX)
LOCAL_MODULE_CLASS := APPS
LOCAL_CERTIFICATE := platform
...
LOCAL_MODULE := DsUI
LOCAL_MODULE_OWNER := xiaomi
LOCAL_SRC_FILES := proprietary/app/DsUI/DsUI.apk
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_SUFFIX := $(COMMON_ANDROID_PACKAGE_SUFFIX)
LOCAL_MODULE_CLASS := APPS
LOCAL_CERTIFICATE := platform
...
LOCAL_MODULE_OWNER := xiaomi
LOCAL_SRC_FILES := proprietary/vendor/lib/libstagefright_soft_ddpdec.so
...
LOCAL_MODULE_OWNER := xiaomi
LOCAL_SRC_FILES := proprietary/vendor/lib/soundfx/libswdap.so
...
LOCAL_SRC_FILES := proprietary/framework/dolby_ds.jar
LOCAL_MODULE_TAGS := optional
